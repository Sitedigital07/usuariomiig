...
Route::get('/usuariolotes', function () {

$colors = DB::table('users')->get()->chunk(1000);
return view('chunk')->with('colors',$colors);

});


Route::get('/usuariolotess', function () {

$colors = DB::table('users')->cursor(1);
return view('chunk')->with('colors',$colors);
